...
<div class="page-quick-sidebar">
    <div class="nav-justified">
        <ul class="nav nav-tabs nav-justified">
            <li class="active">
                <a href="#" data-target="#quick_sidebar_tab_1" data-toggle="tab" dropdown-menu-hover
                   data-close-others="true">
                    Users <span class="badge badge-danger">2</span>
                </a>
            </li>
            <li>
                <a href="#" data-target="#quick_sidebar_tab_2" data-toggle="tab" dropdown-menu-hover
                   data-close-others="true">
                        ...
                        <div class="page-quick-sidebar-chat-user-form">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button type="button" class="btn bg-blue-sharp"><i class="icon-paper-clip"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
